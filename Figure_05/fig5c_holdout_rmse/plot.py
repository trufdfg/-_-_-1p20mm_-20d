...
ax.legend(handles=[Patch(facecolor=COLORS['red'],edgecolor=COLORS['dark'],label='Endpoint'),Patch(facecolor=COLORS['green'],edgecolor=COLORS['dark'],label='Interior')], frameon=False, loc='upper left', fontsize=8)
